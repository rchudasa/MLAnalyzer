...
cmd="cmsRun %s inputFiles=%s maxEvents=%d skipEvents=%d processTask=%s processIsData=%s processIsSignal=%s processIsDebug=%s outputFile=%s"%(cfg,inputFiles_,maxEvents_,skipEvents_,processTask_,processIsData_,processIsSignal_,processIsDebug_,outputFile_)
print '%s'%cmd
os.system(cmd)
